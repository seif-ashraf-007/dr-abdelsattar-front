    ...
    if (window.confirm("Are you sure you want to delete this post?")) {
      try {
        const response = await fetch(
          `http://16.170.230.84:5000/api/blogposts/${postId}`,
          {
            method: "DELETE",
            headers: {
        ...
        <div className={styles.titleBanner}>
          <div className={styles.titleBannerContent}>
            ...
            <div className={styles.titleBannerParagraph}>
              Welcome to our blog section, where we share insights, updates, and
              information on our medical services and telemedicine solutions.
            </div>
          </div>
